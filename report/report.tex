...
% TODO REPLICATION: return after replicatoin is performed.....
...
%   - Round robin scheduler (bad for fragmentation if loads of data will be removed)
%   - Release/Alloc, no other knowledge
%   - Move host principle
