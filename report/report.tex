...
% @Karsten, maybe you should describe this issue: TODO freeing dead memory (not implemented)... If a client doesn't succesfully upload a chunk (e.g. if a storage service dies in the meanwhile) the client will re-request this. So the dictionary should be able to discover that an added file is not written correctly after a while, and put this memory in the freelist again.
